      ...
      <>
        ...
        {kind === "stand" && (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path
              d="M7.3 20.4v-7.2c0-.55.45-1 1-1s1 .45 1 1V8.2c0-.55.45-1 1-1s1 .45 1 1v5h.85V7.2c0-.55.45-1 1-1s1 .45 1 1v6h.85V8.1c0-.55.45-1 1-1s1 .45 1 1v5.1h.85V9.4c0-.55.45-1 1-1s1 .45 1 1v7.1c0 2.7-2.1 4.9-4.8 4.9h-5.1c-2.5 0-4.5-1.7-4.5-1Z"
              fill="#0b0c0f"
            />
            <rect x="10.5" y="17.6" width="5.2" height="1.1" rx="0.55" fill="#0b0c0f" />
          </svg>
        )}
        {kind === "split" && (
