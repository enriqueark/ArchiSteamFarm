          ...
          <div className="w-full max-w-[650px] overflow-hidden rounded-[30px] border border-red-500/60 bg-[#0A0A0A] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.7)]">
            <div className="flex items-center justify-between border-b border-[#1e2937] px-6 pb-3 pt-4">
              <div>
                ...
                <p className="m-0 mt-1 text-[13px] text-[#98A8BD]">Store your Coins and lock funds up to 7 days</p>
              </div>
              <button
                type="button"
                ...
                <>
                  <div className="grid grid-cols-3 gap-3">
                    <div className="rounded-[17px] border border-[#1e2937] bg-[#111111] p-3.5">
                      ...
                      <div className="flex items-center justify-start gap-2 pl-8">
                        <CoinIcon size={18} />
                        <span className="relative -top-[1px] text-[24px] font-bold leading-none text-white">
                    ...
                    <div className="rounded-[17px] border border-[#1e2937] bg-[#111111] p-3.5">
                      ...
                      <div className="flex items-center justify-start gap-2 pl-8">
                        <CoinIcon size={18} />
                        <span className="relative -top-[1px] text-[24px] font-bold leading-none text-[#2DE39D]">
                    ...
                    <div className="rounded-[17px] border border-[#1e2937] bg-[#111111] p-3.5">
                      ...
                      <div className="flex items-center justify-start gap-2 pl-8">
                        <CoinIcon size={18} />
                        <span className="relative -top-[1px] text-[24px] font-bold leading-none text-[#FFC27A]">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    ...
                    >
                      ...
                      <span>{vaultActionLoading ? "Processing..." : "Deposit"}</span>
                    </button>
                    <button
                      type="button"
